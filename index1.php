...
<head>
  ...
  <link rel="stylesheet" href="node_modules/sweetalert2/sweetalert2.min.css" />
    ...
    <div class="container" position:Relative>
      <nav id="main-nav">
        ...
        <ul>
          ...
          <li><a href="work.html">Signout</a></li>
      ...
      <div class="header-content">
        <h1>
          ...
          <span class="txt-type" data-wait="2000" data-words='["Fun For Future"]'></span>
        </h1>
        <p class="lead">
        ...
        <a href="#popup1" class="button factlogo" onclick="myFunction()"><img class="img-fluid" src="icons/icons8-light-on-64.png" alt="" />Fact of the day

          <script>
            function myFunction() {
              Swal.fire({
                title: 'DO U KNOW?',
                text: 'Glass recycling is often separated into colors because glass keeps its color after recycling.',
