...
var Level1 = new Phaser.Class({
  ...
  create: function() {
    ...
    platform_2 = this.add.image(1700, 800, 'platform_medium').setOrigin(0);
    platform_3 = this.add.image(600, 550, 'platform_short').setOrigin(0);
    platform_4 = this.add.image(1000, 650, 'platform_short').setOrigin(0);
  },
