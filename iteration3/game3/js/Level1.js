...
var Level1 = new Phaser.Class({
  ...
  create: function() {
    ...
    this.setUp();
    platform_1 = this.add.image(1250, 750, 'platform_long').setOrigin(0);
    platform_2 = this.add.image(0, 150, 'platform_medium').setOrigin(0);
    platform_3 = this.add.image(550, 600, 'platform_short').setOrigin(0);
    platform_4 = this.add.image(900, 500, 'platform_short').setOrigin(0);
  },
