...
var Baselevel = new Phaser.Class({
    ...
    showScore: function() {
        ...
        scoreText = this.add.text(1705, 50, score, { font: "40px Arial Black", fill: "#fff" }).setStroke('#333333', 16).setShadow(2, 2, "#ffdd00 ", 2, true, true);
        timerText = this.add.text(1705, 160, 'Timer Text', { font: "40px Arial Black", fill: "#fff" }).setStroke('#333333', 16).setShadow(2, 2, "#ffdd00 ", 2, true, true);
    },
