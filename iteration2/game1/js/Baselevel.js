...
var Baselevel = new Phaser.Class({
    ...
    setUp: function () {
        ...
        garbage = this.add.image(900, 580, 'garbage').setOrigin(0);
        recycling = this.add.image(1150, 580, 'recycling').setOrigin(0);
        organic.setScale(.7);
        garbage.setScale(.7);
        ...
        speechBubbleText = this.add.text(250, 200, 'Welcome to Sort Your Waste', { font: "40px Arial Black", fill: "#fff" }).setStroke('#ffdd00', 16).setShadow(2, 2, "#333333", 2, true, true);
